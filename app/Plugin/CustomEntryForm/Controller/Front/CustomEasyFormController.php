...
class CustomEasyFormController
{
    /**
     * お問い合わせ画面.
     *
    ...
    public function index(Application $app, Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            switch ($request->get('mode')) {
                case 'confirm':
                    ...
                    return $app->render(
                        'CustomEntryForm/Resource/template/default/CustomEasyForm/confirm.twig',
                        array(
        ...
        return $app->render(
            'CustomEntryForm/Resource/template/default/CustomEasyForm/index.twig',
            array(
                'form' => $form->createView(),
    ...
    {
        return $app->render(
            'CustomEntryForm/Resource/template/default/CustomEasyForm/complete.twig'
            );
    }
}
