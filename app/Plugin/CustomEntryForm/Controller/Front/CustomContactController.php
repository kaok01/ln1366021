...
class CustomContactController
{
    ...
    public function index(Application $app, Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            switch ($request->get('mode')) {
                case 'confirm':
                    ...
                    return $app->render(
                        'CustomEntryForm/Resource/template/default/CustomContactForm/confirm.twig',
                        array(
        ...
        return $app->render(
            'CustomEntryForm/Resource/template/default/CustomContactForm/index.twig',
            array(
                'form' => $form->createView(),
    ...
    {
        return $app->render(
            'CustomEntryForm/Resource/template/default/CustomContactForm/complete.twig'
            );
    }
}
